        ...
        <div className="dark ">
            ...
            <section className="home " id="home">
                ...
                <div className="home-content">
                    <h3 className="text-center">Hello, <span>It me</span></h3>
                    <h1>Krittiphon Yoonaitham</h1>
                    <h2 className="text-center">I'm a <span className=" multiple-text"></span></h2>
                    <p></p>
                    <div className="text-center  social-media">
                        <a href="https://www.facebook.com/krittiphon.yoonaitham.9"><i className='bx bxl-facebook'></i></a>
                        <a href="https://www.instagram.com/yk1moss"><i className='bx bxl-instagram '></i></a>
                        <a href="https://github.com/Devdummyy"><i className='bx bxl-github'></i></a>
                        <a href="https://www.tiktok.com/@yk1moss?_t=8i7ePfNoJJY&_r=1"><i className='bx bxl-tiktok'></i></a>
                        <a href="https://soundcloud.com/user-980268968"><i className='bx bxl-soundcloud'></i></a>
                    </div>
                </div>
            ...
            <section className="services" id="services">
                ...
                <div className="services-container">
                    ...
                    <div className="services-box">
                        ...
                        <button onClick={handleClick1} className="btn bi bi-box-arrow-in-up-right"> Readmore</button>
                    </div>
                    <div className="services-box">
